...
function App() {
              ...
              params: [
                {
                  ...
                  blockExplorerUrls: ['http://159.69.127.215:3000/']
                },
              ],
            });
          } catch (addError) {
  ...
  const loadNetwork = async () => {
    ...
    } else if (chainIdInt === 7919697) {
      setNetworkName('Aazifiri')
          ...
          <div className="container">
            <Row>
              <div className="col-md-3">
                <p>
                Dymension - Use Explorer for Froopyland Chains, available for all networks.
                </p>
                </div>
              <div className="col-md-9">
                <p className="text-right">
                  <Button variant="secondary" size="sm" onClick={setNetwork}>Switch Aazifiri Network!&nbsp;<img src="https://raw.githubusercontent.com/MetaMask/metamask-extension/develop/app/images/icon-16.png"/></Button>
                </p>
              </div>
            </Row>
            <Row>
              <Col md={12}>
                <p>
                  Developed <a href="https://github.com/enzifiri" target="_blank" rel="noopener noreferrer">Enzifiri</a> Discord: Enzifiri
                </p>
                </Col>
            </Row>
          </div>
